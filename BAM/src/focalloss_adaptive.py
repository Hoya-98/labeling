...
class FocalLossAdaptive(nn.Module):
    def __init__(self, gamma=0, size_average=False, reduction='mean', device=None):
...
criterion3 = FocalLossAdaptive(gamma=2)
loss3 = criterion3(model_output, true_labels)
print("Focal loss Adaptive: ", loss3.item())
